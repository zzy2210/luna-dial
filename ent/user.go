...
// was not loaded in eager-loading.
func (e UserEdges) JournalEntriesOrErr() ([]*JournalEntry, error) {
	if e.loadedTypes[1] {
...
// QueryJournalEntries queries the "journal_entries" edge of the User entity.
func (u *User) QueryJournalEntries() *JournalEntryQuery {
	return NewUserClient(u.config).QueryJournalEntries(u)
}
